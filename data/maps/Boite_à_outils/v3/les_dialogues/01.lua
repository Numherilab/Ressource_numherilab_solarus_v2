-- Lua script of map les_dialogues/01.
...
function map:on_started()
  self.images = {
    sol.surface.create("Info/les_dialogues/map01_1.png"),
    sol.surface.create("Info/les_dialogues/map01_2.png"),
    sol.surface.create("Info/les_dialogues/map01_3.png"),
    sol.surface.create("Info/les_dialogues/map01_4.png"),
    sol.surface.create("Info/les_dialogues/map01_5.png"),
